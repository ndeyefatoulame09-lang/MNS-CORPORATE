...
<div class="bg-white border rounded p-3">
    <div class="row">
        <div class="col-md-6 mb-3">
            ...
            <input class="form-control" name="company_name" required maxlength="180" value="<?php echo clientFormValue('company_name', $client ?? null); ?>">
        ...
        <div class="col-md-6 mb-3">
            ...
            <input class="form-control" type="email" name="email" maxlength="150" value="<?php echo clientFormValue('email', $client ?? null); ?>">
        ...
        <div class="col-md-6 mb-3"><label class="form-label">NINEA</label><input class="form-control" name="ninea" maxlength="50" value="<?php echo clientFormValue('ninea', $client ?? null); ?>"><div class="form-text">Doit rester unique si renseigne.</div></div>
        <div class="col-md-6 mb-3"><label class="form-label">RCCM</label><input class="form-control" name="rccm" maxlength="80" value="<?php echo clientFormValue('rccm', $client ?? null); ?>"><div class="form-text">Doit rester unique si renseigne.</div></div>
        ...
        <div class="col-md-6 mb-3"><label class="form-label">Fin exercice</label><input class="form-control" type="date" name="accounting_year_end" data-after="accounting_year_start" value="<?php echo clientFormValue('accounting_year_end', $client ?? null); ?>"><div class="form-text">La fin doit etre superieure ou egale au debut.</div></div>
        <div class="col-md-6 mb-3">
